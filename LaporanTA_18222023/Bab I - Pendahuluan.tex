...
\begin{enumerate}[label=\alph*.]
  ...
  \item \textbf{Evaluasi kebergunaan (\textit{usability})}, yaitu \textit{User Acceptance Testing} melibatkan sedikitnya 20–30 pengguna internal. Hasil dirangkum menggunakan skor \textit{System Usability Scale} (SUS) dan umpan balik kualitatif terkait kemudahan, kejelasan, dan alur kerja.
\end{enumerate}
