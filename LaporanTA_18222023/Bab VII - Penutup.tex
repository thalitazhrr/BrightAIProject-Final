...
\begin{enumerate}
  ...
  \item Modul pemrosesan bahasa alami telah diimplementasikan menggunakan pendekatan pencocokan pola kata kunci berbobot (\textit{weighted keyword matching}) yang mendukung tujuh \textit{intent} utama dan delapan fokus analisis. Evaluasi kuantitatif terhadap 100 kueri uji berlabel menunjukkan akurasi klasifikasi \textit{intent} sebesar 64\% (skor-F1 makro 0{,}75) dan akurasi pencocokan aturan sebesar 56\% (skor-F1 makro 0{,}50), dengan \textit{coverage rate} 88\% dan latensi klasifikasi kurang dari 1 milidetik. Target metrik klasifikasi belum sepenuhnya tercapai akibat tumpang tindih kata kunci antar-aturan, namun target waktu respons dan cakupan telah terpenuhi.
