...
\begin{enumerate}
  ...
  \item Modul pemrosesan bahasa alami telah diimplementasikan menggunakan pendekatan pencocokan pola kata kunci berbobot (\textit{weighted keyword matching}) yang mendukung tujuh \textit{intent} utama dan delapan fokus analisis. Evaluasi kuantitatif terhadap 100 kueri uji berlabel menunjukkan akurasi pencocokan aturan sebesar \textbf{90\%} dengan skor-F1 makro 0{,}8863 pada 38 kelas aturan. Seluruh target performa berhasil tercapai, termasuk \textit{coverage rate} 93\% dan waktu respons rata-rata 0{,}12 milidetik. Evaluasi difokuskan pada level pencocokan aturan karena taksonomi \textit{intent} dirancang bersifat saling eksklusif secara semantik sehingga klasifikasi pada level tersebut bersifat deterministik. Sisa kesalahan pencocokan aturan (10 dari 100 kueri) disebabkan oleh tumpang tindih kata kunci antar-domain yang bersifat ambigu secara inheren.
