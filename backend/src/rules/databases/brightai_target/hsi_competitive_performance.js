  ...
  SQL_QUERY: `
    ...
    COMPETITIVE_METRICS AS (
        SELECT t.PERIODE,
            ...
            t.UNIT_IDENTIFIER,
            t.TELDA_COVERAGE,
            t.PEER_AVG_ACHIEVEMENT,
            t.PEER_MEDIAN_ACHIEVEMENT,
            t.PEER_STDDEV_ACHIEVEMENT,
            t.PEER_MAX_ACHIEVEMENT,
            t.PEER_MIN_ACHIEVEMENT,
            t.PEER_AVG_VOLUME,
            t.PEER_MAX_VOLUME,
            t.ACHIEVEMENT_PERCENTILE,
            t.VOLUME_PERCENTILE,
    ...
    COMPETITIVE_GAPS AS (
        SELECT t.PERIODE,
            ...
            t.VS_PEER_AVG,
            t.VS_PEER_MEDIAN,
            t.VOLUME_VS_PEER_AVG_PCT,
            t.ACHIEVEMENT_ZSCORE,
    ...
    COMPETITIVE_TRENDS AS (
        SELECT t.PERIODE,
            ...
            t.TOTAL_PEERS,
            t.GAP_TO_LEADER_PCT,
            t.VOLUME_GAP_TO_LEADER_PCT,
            t.GAP_TO_AVERAGE_PCT,
            t.IMPROVEMENT_OPPORTUNITY,
            t.COMPETITIVE_STRENGTH_SCORE,
            t.PREV_ACHIEVEMENT_PCT,
            t.PREV_ACHIEVEMENT_RANK,
