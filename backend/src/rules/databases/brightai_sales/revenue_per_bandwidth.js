  ...
  SQL_QUERY: `
    ...
    REVENUE_METRICS AS (
        SELECT t.BANDWIDTH_CATEGORY,
            ...
            t.HSI_BISNIS_ORDERS,
            t.HSI_BASIC_ORDERS,
            t.TOTAL_HSI_PELANGGAN,
            t.HSI_BISNIS_PELANGGAN,
            t.HSI_BASIC_PELANGGAN,
            t.TOTAL_HSI_LAYANAN,
            t.HSI_BISNIS_LAYANAN,
            t.HSI_BASIC_LAYANAN,
            t.HARD_BUNDLING_ORDERS,
            t.ALACARTE_BUNDLING_ORDERS,
            t.STANDALONE_ORDERS,
            t.PIJAR_ORDERS,
            t.OCA_INTERACTION_ORDERS,
            t.OCA_BLAST_ORDERS,
            t.NETMONK_ORDERS,
            t.REGIONAL_COVERAGE,
            t.WITEL_COVERAGE,
    ...
    FINAL_CALCULATION AS (
        SELECT t.BANDWIDTH_CATEGORY,
            ...
            t.HARD_BUNDLING_PCT,
            t.DIGITAL_PENETRATION_PCT,
            t.ESTIMATED_BASE_ARPU,
            t.BUNDLING_PREMIUM_FACTOR,
            t.DIGITAL_PREMIUM_FACTOR,
    ...
    SELECT 
        ...
        ROUND(TOTAL_MONTHLY_REVENUE_ESTIMATE * 100.0 / NULLIF(SUM(TOTAL_MONTHLY_REVENUE_ESTIMATE) OVER(), 0), 2) as REVENUE_CONTRIBUTION_PCT,
