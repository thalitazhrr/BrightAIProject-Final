  ...
  SQL_QUERY: `
    ...
    SEASONAL_ANALYSIS AS (
        SELECT
            ss.bulan,
            ss.nama_bulan,
            ss.avg_total_pesanan,
            ss.avg_total_pelanggan,
            ss.avg_total_layanan_hsi,
            ss.avg_order_per_pelanggan_ratio,
            ss.avg_layanan_per_plg_ratio,
            ss.avg_order_per_layanan_ratio,
            ss.avg_total_hsi_orders,
            ss.stddev_total_orders,
            ss.min_total_orders,
            ss.max_total_orders,
            ss.avg_total_hsi_customers,
            ss.avg_bisnis_customers,
            ss.avg_basic_customers,
            ss.avg_total_hsi_services,
            ss.avg_bisnis_services,
            ss.avg_basic_services,
            ss.avg_bisnis_orders,
            ss.avg_basic_orders,
            ss.avg_bisnis_mix_pct,
            ss.avg_basic_mix_pct,
            ss.avg_success_rate,
            ss.avg_bundling_rate,
            ss.avg_hard_bundling_rate,
            ss.avg_digital_penetration,
            ss.avg_voice_combo_rate,
            ss.avg_monthly_bandwidth_kbps,
            ss.avg_regional_coverage,
            ss.avg_new_sales_mix_pct,
            ss.avg_expansion_mix_pct,
            ss.avg_disconnect_rate_pct,
            ss.avg_resume_rate_pct,
            ss.avg_education_mix_pct,
            ss.avg_government_mix_pct,
            ss.avg_hospitality_mix_pct,
            ss.avg_agriculture_mix_pct,
            ss.avg_manufacturing_mix_pct,
            ss.avg_healthcare_mix_pct,
            ss.avg_new_customer_mix_pct,
            ss.avg_established_mix_pct,
            ss.avg_longterm_mix_pct,
            ss.avg_tenure_months,
            ss.years_of_data,
