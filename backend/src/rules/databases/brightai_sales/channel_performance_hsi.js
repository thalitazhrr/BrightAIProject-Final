  ...
  SQL_QUERY: `
    ...
    CHANNEL_PERFORMANCE AS (
        SELECT t.CHANNEL_NAME,
            ...
            t.HSI_BASIC_ORDERS,
            t.TOTAL_ORDERS,
            t.HSI_CONVERSION_RATE,
            t.HSI_BISNIS_CONVERSION_RATE,
            t.HSI_BASIC_CONVERSION_RATE,
            t.HSI_SUCCESS_RATE,
            t.HARD_BUNDLING_ORDERS,
            t.TOTAL_BUNDLING_ORDERS,
            t.BUNDLING_RATE,
            t.DIGITAL_PRODUCT_ORDERS,
            t.DIGITAL_PENETRATION_RATE,
            t.NEW_SALES_ORDERS,
            t.ADD_SERVICE_ORDERS,
            t.MODIFICATION_ORDERS,
            t.NEW_SALES_CONVERSION_RATE,
            t.ADD_SERVICE_CONVERSION_RATE,
            t.MODIFICATION_CONVERSION_RATE,
            t.GOVERNMENT_ORDERS,
            t.EDUCATION_ORDERS,
            t.HEALTHCARE_ORDERS,
            t.INDIVIDUAL_ORDERS,
            t.FINANCIAL_ORDERS,
            t.GOVERNMENT_HSI_CONVERSION,
            t.EDUCATION_HSI_CONVERSION,
            t.INDIVIDUAL_HSI_CONVERSION,
            t.AVG_HSI_FULFILLMENT_TIME,
            t.REGIONAL_COVERAGE,
            t.WITEL_COVERAGE,
            t.STO_COVERAGE,
