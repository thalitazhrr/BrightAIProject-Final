  ...
  SQL_QUERY: `
    ...
    PERFORMA_INSTALASI AS (
        SELECT t.REGIONAL,
            ...
            t.TOTAL_INSTALASI_HSI,
            t.INSTALASI_HSI_BISNIS,
            t.INSTALASI_HSI_BASIC,
            t.TOTAL_HSI_SERVICES_INSTALLED,
            t.TOTAL_HSI_CUSTOMERS_INSTALLED,
            t.RATA_RATA_WAKTU_INSTALASI_HSI,
            t.MEDIAN_WAKTU_INSTALASI_HSI,
            t.AVG_SERVICE_INSTALLATION_TIME,
            t.RATA_RATA_WAKTU_BISNIS,
            t.RATA_RATA_WAKTU_BASIC,
            t.INSTALASI_TERCEPAT_HSI,
            t.INSTALASI_TERLAMBAT_HSI,
            t.SESUAI_SLA_7HARI,
            t.SESUAI_SLA_14HARI,
            t.SERVICES_SLA_7HARI,
            t.CUSTOMERS_SLA_7HARI,
            t.RATA_RATA_WAKTU_HARD_BUNDLING,
            t.RATA_RATA_WAKTU_STANDALONE,
            t.RATA_RATA_WAKTU_PIJAR,
            t.RATA_RATA_WAKTU_OCA,
            t.RATA_RATA_WAKTU_PENJUALAN_BARU,
            t.RATA_RATA_WAKTU_TAMBAH_LAYANAN,
            t.RATA_RATA_WAKTU_MODIFIKASI,
            t.RATA_RATA_WAKTU_PDA,
            t.SLA_PENJUALAN_BARU_7HARI,
            t.TOTAL_PENJUALAN_BARU,
            t.SLA_TAMBAH_LAYANAN_7HARI,
            t.TOTAL_TAMBAH_LAYANAN,
            t.RATA_RATA_WAKTU_PENDIDIKAN,
            t.RATA_RATA_WAKTU_PEMERINTAHAN,
            t.RATA_RATA_WAKTU_KESEHATAN,
            t.SLA_PENDIDIKAN_7HARI,
            t.TOTAL_PENDIDIKAN,
            t.SLA_PEMERINTAHAN_7HARI,
            t.TOTAL_PEMERINTAHAN,
            t.KONSISTENSI_WAKTU_STDDEV,
    ...
    SELECT 
        ...
        ROUND(RATA_RATA_WAKTU_HARD_BUNDLING, 1) as RR_WAKTU_HARD_BUNDLING_HARI,
        ROUND(RATA_RATA_WAKTU_STANDALONE, 1) as RR_WAKTU_STANDALONE_HARI,
        ROUND(RATA_RATA_WAKTU_PIJAR, 1) as RATA_RATA_WAKTU_PIJAR_HARI,
        ROUND(RATA_RATA_WAKTU_OCA, 1) as RATA_RATA_WAKTU_OCA_HARI,
        ROUND(RATA_RATA_WAKTU_PENJUALAN_BARU, 1) as RR_WAKTU_PENJUALAN_BARU_HARI,
        ROUND(RATA_RATA_WAKTU_TAMBAH_LAYANAN, 1) as RR_WAKTU_TAMBAH_LAYANAN_HARI,
        ROUND(RATA_RATA_WAKTU_MODIFIKASI, 1) as RR_WAKTU_MODIFIKASI_HARI,
        ROUND(RATA_RATA_WAKTU_PDA, 1) as RATA_RATA_WAKTU_PDA_HARI,
        KEPATUHAN_SLA_PENJUALAN_BARU,
        KEPATUHAN_SLA_TAMBAH_LAYANAN,
        ROUND(RATA_RATA_WAKTU_PENDIDIKAN, 1) as RR_WAKTU_PENDIDIKAN_HARI,
        ROUND(RATA_RATA_WAKTU_PEMERINTAHAN, 1) as RR_WAKTU_PEMERINTAHAN_HARI,
    ...
    formatIndonesianResponse: function(data) {
      ...
      const hasil_analisis = data.map(sto => {
        const perbaikan = this.identifikasiAreaPerbaikan(
          ...
          sto.RR_WAKTU_HARD_BUNDLING_HARI
        );
        ...
        return {
          ...
          analisis_per_produk: {
            ...
            rata_rata_hard_bundling: `${sto.RR_WAKTU_HARD_BUNDLING_HARI || 0} hari`,
            rata_rata_standalone: `${sto.RR_WAKTU_STANDALONE_HARI || 0} hari`,
          ...
          analisis_jenis_transaksi: {
            rata_rata_penjualan_baru: `${sto.RR_WAKTU_PENJUALAN_BARU_HARI || 0} hari`,
            rata_rata_tambah_layanan: `${sto.RR_WAKTU_TAMBAH_LAYANAN_HARI || 0} hari`,
            rata_rata_modifikasi: `${sto.RR_WAKTU_MODIFIKASI_HARI || 0} hari`,
          ...
          analisis_ekosistem: {
            rata_rata_pendidikan: `${sto.RR_WAKTU_PENDIDIKAN_HARI || 0} hari`,
            rata_rata_pemerintahan: `${sto.RR_WAKTU_PEMERINTAHAN_HARI || 0} hari`,
